...
import (
	...
	clusteraccesspkg "github.com/openmfp/kubernetes-graphql-gateway/listener/reconciler/clusteraccess"
...
func PreReconcileWithClusterAccess(
	...
	for _, item := range clusterAccessList.Items {
		...
		targetConfig, clusterName, err := clusteraccesspkg.BuildTargetClusterConfigFromTyped(item, client)
		if err != nil {
